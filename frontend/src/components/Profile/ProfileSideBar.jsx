...
function ProfileSideBar() {
  return (
    <div>
      <aside className="w-full  bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 ">

        <div className="h-24 bg-blue-600"></div>


        <div className=" w-full flex flex-col items-center p-4 -mt-12 ">
          <img
        ...
        <div className="px-4 py-2 border-t border-b border-gray-100 text-sm text-gray-700 hidden md:block">
        ...
        <div className="p-4 text-sm text-gray-700 hidden md:block">
